// Traced brand marks, taken from codenotch (github.com/vinzdg/codenotch),
// MIT License, Copyright (c) 2026 Vinz. Reproduced here unchanged apart
// from this header. See THIRD_PARTY.md.
